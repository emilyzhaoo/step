...
public final class FindMeetingQueryTest {
  ...
  public void busyOptionalAttendee() {
    // Add optional attendee C who has an all-day event
  ...
  public void includeOptionalAttendee() {
    // Add optional attendee C who has an event between 8:30 and 9:00 
  ...
  public void justEnoughRoomWithOptional() {
    // Add optional attendee B with event between 8:30 and 8:45
  ...
  public void onlyOptionalAttendees() {
    // Two optional attendees with gaps in their schedule
